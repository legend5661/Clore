...
class HRNetModel(ISModel):
    ...
    def refine(self, cropped_image, cropped_points, full_feature, full_logits, bboxes):
        ...
        # print(f'refine   cropped_feature.shape{cropped_feature.shape}, cropped_logits.shape:{cropped_logits.shape}, \
        #     cropped_image.shape:{cropped_image.shape}')
        
        click_map = self.dist_maps_refine( cropped_image,cropped_points)
        # print(f'image_focus.shape:{cropped_image.shape}')
    ...
    # def hrnet_refine(self, cropped_image, cropped_points):
