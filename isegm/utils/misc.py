...
def save_checkpoint(net, checkpoints_path, epoch=None, prefix='', verbose=True, multi_gpu=False, best_val=None, lr=None):
    if epoch is None:
    ...
    if best_val is not None:
        checkpoint_name = f'val_iou={best_val:.2f}_{checkpoint_name}'
