...
class ISDataset(torch.utils.data.dataset.Dataset):
    ...
    def __getitem__(self, index):
        ...
        #     try:
                ...
                # print(f'__getitem__  {mask.shape}, {image.shape}')
                if self.with_refiner:
                    ...
                    # print('__getitem__')
                    # print(output['images'].shape, output['images_focus'].shape, output['instances'].shape, output['instances_focus'].shape)
                    # print('__getitem__')
