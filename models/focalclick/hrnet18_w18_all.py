...
from isegm.engine.clore_trainer import ISTrainer
...
def init_model(cfg):
    ...
    model = HRNetModel(pipeline_version = 's2', width=18, ocr_width=64, small=False, with_aux_output=True, use_leaky_relu=True,
...
def train(model, cfg, model_cfg):
    ...
    loss_cfg.instance_refine_loss = SoftIoU()
    loss_cfg.instance_refine_loss_weight = 1.0
